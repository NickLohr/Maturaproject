...
def fit_to_lesson(filenames,aps,time_table_dic, filename_tt="save9.gpn",filter_function=filter_mac):
    """
...
def reverse_tracking(filenames,aps,time_table_dic,filename_tt="save9.gpn"):
    ...
    """
    classes=fit_to_lesson(filenames,aps,time_table_dic,filename_tt=filename_tt,filter_function=filter_mac_all)
    solution={}
    for k in classes:
