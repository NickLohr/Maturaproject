...
def fit_to_lesson(filenames,aps,filename_tt="save9.gpn",filter_function=filter_mac):
    """
        ...
        for  lesson in lessons:
            ...
            if time >= int(lesson[0]):
                if time<=int(lesson[1]):
                    ...
                    print(str(roomsystem[2].weekday()+1),lesson[0],roomsystem[1])
                    ...
                    print(str(roomsystem[2].weekday()+1),lesson[0],roomsystem[1],2)
...
def list_to_percent(classes):
    ...
    for classe in classes:
        ...
        if classe == []:
            continue
        #remove classes without teachers
        if len(classe)==1:
...
def track_mac(mac,filenames,aps,filename_tt="save9.gpn"):
    """
    ...
    """
    classes=fit_to_lesson(filenames,aps,filename_tt)
...
def reverse_tracking(filenames,aps,filename_tt="save9.gpn"):
    ...
    """
    classes=fit_to_lesson(filenames,aps,filename_tt,filter_function=filter_mac_all)
    solution={}
    for k in classes:
